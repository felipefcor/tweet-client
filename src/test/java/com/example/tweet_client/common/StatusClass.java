package com.example.tweet_client.common;
...
public class StatusClass {
    ...
    public static Status statusClassWithMoreThan1500Followers(){
    ...
    public static Status statusClassWithLessThan1500Followers(){
